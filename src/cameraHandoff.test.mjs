...
const voice = [
  'src/voice/actions/moveCamera.js',
  'src/voice/actions/flyRoute.js',
  'src/voice/actions/trackEntity.js',
  'src/voice/actions/frameOverhead.js',
  'src/voice/actions/getCurrentViewState.js',
]
