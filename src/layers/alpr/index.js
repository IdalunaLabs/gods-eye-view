...
import {
  LAYER_ID,
  REQUEST_DEBOUNCE_MS,
  QUERY_LIMIT as _QUERY_LIMIT,
  MAX_RENDERED,
  QUERY_SNAP_DEGREES as _QUERY_SNAP_DEGREES,
  QUERY_REUSE_MS,
  ALPR_COLOR,
} from './policy.js';
import {
  snapAlprBox,
  boxContains,
  destinationPointDeg as _destinationPointDeg,
  alprRetryDelayMs,
...
export function createAlprCamerasLayer({ source, services } = {}) {
  ...
  const {
    ...
    clearRendered,
    hideOnMapCredit,
    presentOnMapCredit: _presentOnMapCredit,
    renderRecords,
    selectRecord: _selectRecord,
    focusNearest,
    clearSelection,
